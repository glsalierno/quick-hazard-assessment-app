...
- **Hazard summary:** Short narrative from GHS codes, flash point, and toxicity screening bands
- **Example report:** Bundled **1,3-dioxolane** (CAS `646-06-0`) snapshot that opens without a live PubChem fetch
