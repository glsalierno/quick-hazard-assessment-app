...
def cas_checksum(registration_digits: str) -> int:
    """
    CAS Registry check digit from **registration** digits only (no check digit, no hyphens).

    Weights 1, 2, 3, … from the **rightmost** registration digit to the left; sum mod 10 equals the check digit.
    """
